...
<!-- Checks if Course is Completed and replaces the course page copy -->
<?php if ( $course_status == __( 'Completed', 'learndash' ) ) :?>

<!-- Include whatever you want to display instead of the course content. I chose to display the message below, plus intuitive navigation to additional courses that are available. You could just as easily provide a link to download their certificate or show a list of courses they've completed etc. -->
	<h2>Congratulations! You have successfully completed this course.</h2>

	<!-- Include course navigation code or useful links etc. -->
	
	<br><h3>We will send you your certificate by email in due course. </h3> <br>
...
?>
<?php endif; ?>
<!-- END - Checks if Course is Completed -->
