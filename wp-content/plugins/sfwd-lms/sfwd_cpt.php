...
/*
 	iHm crowbar because of the broken permalinks!!!!!			
			...
			*/
			...
			$buf .='<li id="post-10" class="is_not_sample"><h4><a class="completed" href="http://stereotypes.genderhub.org/lessons/an-introduction-to-gender-stereotypes/">Lesson 1 – An Introduction to Gender Stereotypes</a><div id="learndash_topic_dots-10" class="learndash_topic_dots type-dots"><a class="topic-completed" href="http://gender.umfundi.com/topic/what-are-gender-stereotypes/"><span title="What are gender stereotypes?"></span></a></div></h4></li>';
			$buf .='<li id="post-10728" class="is_not_sample"><h4><a class="completed" href="http://stereotypes.genderhub.org/lessons/lesson-2-manifestations-and-impacts-of-gender-stereotypes/">Lesson 2 – Manifestations and Impacts of Gender Stereotypes</a><div id="learndash_topic_dots-10728" class="learndash_topic_dots type-dots"></div></h4></li>';
			$buf .='<li id="post-10731" class="is_not_sample"><h4><a class="completed" href="http://stereotypes.genderhub.org/lessons/lesson-3-strategies-and-interventions/">Lesson-3 – Strategies and Interventions</a><div id="learndash_topic_dots-10731" class="learndash_topic_dots type-dots"><a class="topic-completed" href="http://gender.umfundi.com/topic/using-policy-and-rights-frameworks-to-challenge-gender-stereotypes/"><span title="Using policy and rights frameworks to challenge gender stereotypes"></span></a></div></h4></li>';
			$buf .='<li id="post-10733" class="is_not_sample"><h4><a class="completed" href="http://stereotypes.genderhub.org/lessons/conclusion">Conclusion</a><div id="learndash_topic_dots-10733" class="learndash_topic_dots type-dots"></div></h4></li>';
